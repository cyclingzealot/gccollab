...
<script>
    alert('/home/jlam/code/gccollabHome/gccollab/mod/gc_onboard/views/default/welcome-steps/nudge_modal.php was loaded!');
    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class=""  id="welcome-step" tabindex="-1">
            ...
            <div class="clearfix">
                ...
                <h2 class="pull-left"> <?php echo elgg_echo('onboard:nudge:intro:title'); ?></h2>
